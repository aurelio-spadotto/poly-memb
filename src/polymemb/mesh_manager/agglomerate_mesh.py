...
def agglomerate (mesh, ref_mesh, cryt_size, cryt_skewness, verbose=False):
    ...
    agglomerated_mesh = lm.mesh2D (elem2node, mesh.coords, bnd_dof_type = "edge", d = mesh.d)
    # provide cuts
    ...
    # set side mask
    bm.fill_side_mask(agglomerated_mesh, len(ref_mesh.coords))
